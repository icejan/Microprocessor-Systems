...
T_FWD       dc.b    1  	  		  		  ; FWD time
T_REV       dc.b    1  	  		  	  	  ; REV time
T_FWD_TRN   dc.b    1      	  		  	  ; FWD_TURN time 
T_REV_TRN   dc.b    1  	  		  		  ; REV_TURN time

TEN_THOUS   dc.b    1     	  		  	  ; 10,000 digit
THOUSANDS   dc.b    1  	  		  		  ; 1,000 digit
HUNDREDS    dc.b    1     	  		  	  ;   100 digit
TENS        dc.b    1     	  		  	  ;    10 digit
UNITS       dc.b    1  	  		  		  ;     1 digit
BCD_SPARE   RMB     2               ; Extra space for decimal point and string terminator 
NO_BLANK    dc.b    1  	  		  	 	  ; Used in ’leading zero’ blanking by BCD2ASC  
...
INIT_FWD_TRN BSET   PORTA,%00000010		  ; Set REV dir. for STARBOARD (right) motor
             LDAA   TOF_COUNTER		      ; Mark the fwd_turn time Tfwdturn ADDA #FWD_TRN_INT
             ADDA   #FWD_TRN_INT
             STAA   T_FWD_TRN
             RTS
...
UPDT_DISPL   MOVB   #$90,ATDCTL5            ; R-just., uns., sing. conv., mult., ch=0, start
             ...
             LDAA   #$91                       ; move LCD cursor to the 1st row, end of msg1
             JSR    cmd2LCD                    ; ""
        
             LDAA   TEN_THOUS                  ; output the TEN_THOUS ASCII character
             JSR    putcLCD                    ; ""
             LDAA   THOUSANDS                  ; same for THOUSANDS, ’.’ 
             JSR    putcLCD
             LDAA   HUNDREDS                   ; and HUNDREDS
             JSR    putcLCD
;------------------------- 
