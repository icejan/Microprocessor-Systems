 ;*********************************************************************
;* This program prints a text message followed by two hexadecimal    *
;* values to the LCD                                                 *
;* Course: COE538                                                    *
;* Lab 2 Assignment 2: Display Message and Hez Value                 *
;*                                                                   *
;* Author: Janice Zhu                                                *
;* Student #:   Section: 2                                           *
;* Section: 2                                                        *
...
FIRSTHEX    FCB   $3F                  ; first hexadecimal value. should write ?
SECHEX      FCB   $23                  ; second hexadecimal value writes #

mem        dc.b   $11,$22,$33,$44,$55               ; stored mem1...?
...
MainLoop    JSR   clrLCD              ; clear LCD  & home cursor
            ...
            LDAA  FIRSTHEX            ; load contents at $3000 into A
            JSR   leftHLF             ; convert left half of A into ASCII
            STAA  mem                ; store the ASCII byte into mem1
            
            LDAA  FIRSTHEX            ; load contents at $3000 into A
            JSR   rightHLF            ; convert right half of A into ASCII
            STAA  mem                ; store the ASCII byte into mem2
            
            LDAA  SECHEX              ; load contents at $3001 into A
            JSR   leftHLF             ; convert left half of A into ASCII
            STAA  mem                ; store the ASCII byte into mem3
            
            LDAA  SECHEX              ; load contents at $3001 into A
            JSR   rightHLF            ; convert right half of A into ASCII
            STAA  mem                ; store the ASCII byte into mem4
            
            LDAA  0                   ; load 0 into A
            STAA  mem                ; store string termination character 00 into mem5
            
            LDX   #mem               ; output the 4 ASCII characters
            JSR   putsLCD             ;  -"-
